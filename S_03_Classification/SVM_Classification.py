# -*- coding: utf-8 -*-
"""
Support Vector Machine Classification of a simple dataset

Created on Thu Dec 15 15:17:59 2022
...
# %% Step 7a: Train the SVM model on the training set
classifier = SVC(kernel='linear', random_state=0)
classifier.fit(x_train, y_train)  # fit the classification to the training set
