# -*- coding: utf-8 -*-
"""
Random Forest Regression analysis of a simple dataset

Created on Mon Dec 12 10:41:02 2022
...
# %% Step 7: Fitting a Random Forest model to the dataset
...
plt.title('Distance Vs. Cost (Random Forest Regression)')
